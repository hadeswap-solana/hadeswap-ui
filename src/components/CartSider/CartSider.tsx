                ...
                <div className={styles.cardsSection}>
                  <div className={styles.cartTitle}>
                    <Typography.Title level={4}>
                      buy&nbsp;{cartItems.buy.length}&nbsp;{cartItems.buy.length > 1 ? 'NFTs' : 'NFT'}
                    </Typography.Title>
                    <Typography.Text>
